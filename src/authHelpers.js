import authCreds from './authCreds.js';
import axios from "axios";

const authHelpers = {
  getAuth: function () {
          console.log('authCreds:', authCreds); // Add this line to debug
          let url = authCreds.auth_endpoint
            + '?response_type=' + authCreds.response_type
